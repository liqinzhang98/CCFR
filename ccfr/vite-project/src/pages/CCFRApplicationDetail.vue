<template>
    <div id="single-blog">
        ...
        <div class = "buttonDiv" style = "display: flex; align-items: center; width: 100%;">
            <button class="acceptButton" v-on:click="acceptApp"> Approve </button>
            <button class="rejectButton" v-on:click="rejectApp"> Reject </button>
        </div>
        <br /> 
    ...
    methods: {
        async acceptApp(){
            if(this.isVote == false){
                if ((this.theApplication.voteAccept + this.theApplication.voteReject) != 0){
                    const db = getFirestore();
                    ...
                    this.isVote = true
                    ElMessage.success("You have approved this application !");  
                }else{
                    ElMessage.error("You need to wait for BWG chair vote for this application !")
                }         
            }else{
                ElMessage.error("You have already approved or rejected this application !");    
            }
        ...
        async rejectApp(){
            if(this.isVote == false){
                if ((this.theApplication.voteAccept + this.theApplication.voteReject) != 0){
                    ...
                    this.isVote = true
                    ElMessage.success("You have rejected this application !");  
                }else{
                    ElMessage.error("You need to wait for BWG chair vote for this application !")
                }
            }else{
