...
<!-- Section 3 -->
        ...
        <div class = "buttonDiv" style = "display: flex; align-items: center; width: 100%;">
            <button class="acceptButton" v-on:click="deleteApp"> Delete </button>
        </div>
        <br />
        <div class = "buttonDiv" style = "display: flex; align-items: center; width: 100%;">
            <button class="acceptButton" v-on:click="toAllApp"> Back </button>
        </div>
    </div>
  </template>
  ...
  <script>
  // Imports
  import { getFirestore, doc, collection, getDocs, updateDoc, deleteDoc} from "firebase/firestore"
  ...
  export default {
    data () {
        return {
            ...
            theApplication: {},
            // step progress bar
            mySteps: ['BWG Chair reviewing', 'CCFR Chair reviewing', 'Collecting votes', 'Final reviewing'],
            currentStep:0,
            isVote: false
        }
    },
    ...
    methods: {
        ...
        async deleteApp(){
            ...
            ElMessage.success("You delete this application !"); 
        },
        toAllApp(){
            this.$router.replace('/user/'+ this.theApplication.userId)
        }
  }
}
  </script>
